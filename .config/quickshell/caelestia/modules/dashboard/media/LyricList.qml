...
Item {
    ...
    Connections {
        function onLyricsChanged() {
            ...
            const trackChanged = track !== root.currentTrack;
            root.currentTrack = track;
            root.updateLyrics(trackChanged);
        }
    ...
    Loader {
        ...
        sourceComponent: ColumnLayout {
            ...
            StyledText {
                text: root.converting && Romaji.mode === "english" ? qsTr("Translating lyrics...") : qsTr("Loading lyrics...")
    ...
    Loader {
        ...
        sourceComponent: ColumnLayout {
            ...
            StyledText {
                text: Romaji.mode === "english" && Lyrics.hasLyrics ? qsTr("No translation found") : qsTr("No lyrics found")
                color: Colours.palette.m3outline
                font: Tokens.font.title.medium
            }
        }
