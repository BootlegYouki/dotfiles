...
Singleton {
    ...
    readonly property HyprKeyboard keyboard: extras.devices.keyboards.find(kb => kb.name === "hfd.cn-usb-device-keyboard") ?? extras.devices.keyboards.find(kb => kb.main) ?? null
